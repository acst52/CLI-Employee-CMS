...
// ***** COPIED FROM ORM > 10-Ins-Instance-Method > routes > api > userRoutes.js
...
// Route for instance method hasPets - a user can visit this url to check if a user at the specified id has pets
  // we create GET route to see if user has pets. if user hits API endpoint, they will see if they have pets or not
...
router.get('/:id/hasPets', async (req, res) => {
  try {
    ...
    const petData = userData.hasPets(); // fcn called here instead of 20+ lines of code
